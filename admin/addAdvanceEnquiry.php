...
$conn = mysqli_connect("127.0.0.1","root-1","nibh@1713","nibh-v1");
    ...
    Following are your order details:
		...
		if ($query) {
                ...
                curl_close($ch);
 			    ...
 			    header('Location: advanceEnquiry.php');
 			    echo "in data sucess";
 			    echo "<br>";
 			    echo "<br>";
 			    echo $stream;
        ...
        $sql4 = "update placedorder2 set orderby='$qw' WHERE id = '$updateId'" ;
	...
	if (isset($_POST['acceptEnquiry'])) {
		...
		$msg = "Your Order is forwarded for pre-processing, Will update you further";
		 $sql1 = "INSERT INTO placedorder2 (id,OrderId,OrderDate,OrderYear,MobileNo,CustomerName,Stream,Branch,Year,Sem,Book,Publication,Author,Quantity,language,isbn,totalprice,Delivery,Address,Instructions,pid,orderby) SELECT id,OrderId,OrderDate,OrderYear,MobileNo,CustomerName,Stream,Branch,Year,Sem,Book,Publication,Author,Quantity,language,isbn,totalprice,Delivery,Address,Instructions,pid,orderby FROM advanceEnquiry WHERE id = '$id'";
		 $sql2 = "insert into userlogs (OrderId,CustomerName,MobileNo) select OrderId,CustomerName,MobileNo from allstatus2 where id = '$id'";
		 
		 $sql3 = "update userlogs set Status = '".$msg."' where id = '$id'";
		 $sql4 = "update allstatus2 set Status = 'PO' where id = '$id'";
		  $sql5 = "DELETE FROM allstatus2 WHERE id='$id'";
		 //echo $sql3;
    ...
    if(isset($_POST['updateBtn'])){
        ...
        $sql4 = "update advanceEnquiry set CustomerName='$custName1', MobileNo='$mobileNo1', Stream='$strea', Branch='$branch', Year='$year', Sem='$sem', Book='$book', Publication='$publication', Author='$author', Instructions='$Instructions1', totalprice='$totalprice', Quantity='$Quantity1', Delivery='$delivery1', Address='$address1' where id='$updateId' ";
$sql5 = "update allstatus2 set CustomerName='$custName1', MobileNo='$mobileNo1', Stream='$strea', Branch='$branch', Year='$year', Sem='$sem', Book='$book', Publication='$publication', Author='$author', Instructions='$Instructions1', totalprice='$totalprice', Quantity='$Quantity1', Delivery='$delivery1', Address='$address1' where id='$updateId' ";
    ...
    //Delete Data
     if(isset($_POST['deleteEnquiry'])){
        ...
        $sql4 = "DELETE FROM allstatus2 WHERE id='$deleteId'";

        $query4 = mysqli_query($conn,$sql4);
        
        if($query4){
            header('Location: allstatus2.php');
			echo "in data sucess";
        }
        else{
            echo mysql_error();
