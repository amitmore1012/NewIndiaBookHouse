...
$conn = mysqli_connect("127.0.0.1","root-1","nibh@1713","nibh-v1");
	...
	if (isset($_POST['deliveryEnquiry'])) {
        ...
        $sql10 = "select * from message where msgType='DeliveryOrder'";
		 ...
		 $sql3 = "update enquiry set Status = 'DO' where id = '$id'";
		 $sql4 = "DELETE FROM placedorder1 where id = '$id'";
		 ...
		 if ($query1) {
		 	...
		 	header('Location: placedOrder1.php');
			echo "in data sucess"; 
		 	        }  
		 	    }
		 }
