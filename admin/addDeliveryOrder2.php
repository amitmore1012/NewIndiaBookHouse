...
$conn = mysqli_connect("127.0.0.1","root-1","nibh@1713","nibh-v1");
	...
	if (isset($_POST['deliveryEnquiry'])) {
        ...
        $sql10 = "select * from message where msgType='DeliveryOrder'";
		 ...
		 $sql3 = "update advanceEnquiry set Status = 'DO' where id = '$id'";
		 $sql4 = "DELETE FROM placedorder2 where id = '$id'";
		 ...
		 if ($query1) {
		 	...
		 	header('Location: placedOrder2.php');
			echo "in data sucess"; 
		 	        }  
		 	    }
		 }
		     ...
		     $sql1 = "INSERT INTO completedorder2 (id,OrderId,OrderDate,OrderYear,MobileNo,CustomerName,Stream,Branch,Year,Sem,Book,Publication,Author,Quantity,language,isbn,totalprice,Delivery,Address,Instructions,pid,orderby) SELECT id,OrderId,OrderDate,OrderYear,MobileNo,CustomerName,Stream,Branch,Year,Sem,Book,Publication,Author,Quantity,language,isbn,totalprice,Delivery,Address,Instructions,pid,orderby FROM placedorder2 WHERE id = '$id'";
		     $query1 = mysqli_query($conn, $sql1);
		   $sql = "select * from placedorder2 where id='$id'";
         $query = mysqli_query($conn,$sql);
         foreach($query as $q){
        ...
        $route = "4";
		 ...
		 $sql3 = "update advanceEnquiry set Status = 'CO' where id = '$id'";
		 $sql4 = "DELETE FROM placedorder2 where id = '$id'";
