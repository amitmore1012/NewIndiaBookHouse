...
$conn = mysqli_connect("127.0.0.1","root-1","nibh@1713","nibh-v1");
	...
	if (isset($_POST['saveBtn'])) {
		...
		$sql = "insert into publicationHouse(stream, branch, year, sem, book, publication, author, language, isbn, price, discount, ourprice, image) values ('$stream','$branch','$year','$sem','$book','$publication','$author','$Language','$ISBN', '$price', '$discount', '$ourprice', '$image')";
		...
		if ($query) {
 		...
 		if($f == "featured"){
 			    ...
 			    if($query1){
 			        header('Location: publicationHouse.php');
 			    }
	    }
    ...
    if(isset($_POST['updateBtn'])){
        ...
        $sql4 = "update publicationHouse set stream='$Stream1', branch='$Branch1', year='$Year1', sem='$Sem1', book='$Book1', publication='$Publication1', author='$Author1', language='$Lang1',isbn='$ISBN1', price='$Price1' where id='$updateId' ";
    ...
    //Delete Data
     if(isset($_POST['deleteEnquiry'])){
        ...
        $sql4 = "DELETE FROM publicationHouse WHERE id='$deleteId'";
